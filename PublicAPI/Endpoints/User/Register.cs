...
namespace PublicAPI.Endpoints.User
{
    public class Register : EndpointBaseAsync.WithRequest<RegisterRequest>.WithActionResult<RegisterResponse>
    {
        ...
        [HttpPost("user")]
        public override async Task<ActionResult<RegisterResponse>> HandleAsync(RegisterRequest request,
            CancellationToken cancellationToken = new())
        {
            try
            {
                ...
                var token = newUser.GenerateToken(_configuration["JWTSigningKey"]);
